...
scenarios('../features/DELETE_BookStore_v1_Books.feature')
...
@given(parsers.parse('I am making a DELETE request to "/BookStore/v1/Books"'))
def prepare_request():
    """Prepare the request context."""
    request_context["method"] = "DELETE"
    request_context["path"] = "/BookStore/v1/Books"
