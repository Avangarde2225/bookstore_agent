...
scenarios('../features/crud/test_bookstore_crud_e2e.feature')
...
@given(parsers.parse('I am making a CRUD request to "/crud"'))
def prepare_request():
    """Prepare the request context."""
    request_context["method"] = "CRUD"
    request_context["path"] = "/crud"
