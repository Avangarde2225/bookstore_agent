...
scenarios('../features/POST_Account_v1_GenerateToken.feature')
...
@given(parsers.parse('I am making a POST request to "/Account/v1/GenerateToken"'))
def prepare_request():
    """Prepare the request context."""
    request_context["method"] = "POST"
    request_context["path"] = "/Account/v1/GenerateToken"
