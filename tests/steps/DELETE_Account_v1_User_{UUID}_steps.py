...
scenarios('../features/DELETE_Account_v1_User_{UUID}.feature')
...
@given(parsers.parse('I am making a DELETE request to "/Account/v1/User/{UUID}"'))
def prepare_request():
    """Prepare the request context."""
    request_context["method"] = "DELETE"
    request_context["path"] = "/Account/v1/User/{UUID}"
