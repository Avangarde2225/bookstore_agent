...
scenarios('../features/PUT_BookStore_v1_Books_{ISBN}.feature')
...
@given(parsers.parse('I am making a PUT request to "/BookStore/v1/Books/{ISBN}"'))
def prepare_request():
    """Prepare the request context."""
    request_context["method"] = "PUT"
    request_context["path"] = "/BookStore/v1/Books/{ISBN}"
