...
scenarios('../features/POST_Account_v1_Authorized.feature')
...
@given(parsers.parse('I am making a POST request to "/Account/v1/Authorized"'))
def prepare_request():
    """Prepare the request context."""
    request_context["method"] = "POST"
    request_context["path"] = "/Account/v1/Authorized"
