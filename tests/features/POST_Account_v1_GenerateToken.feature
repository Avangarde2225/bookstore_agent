Feature: POST /Account/v1/GenerateToken API Endpoint

  As an API client
  I want to interact with the /Account/v1/GenerateToken endpoint
  ...
  Scenario: Successful response validation
    Given I am making a POST request to "/Account/v1/GenerateToken"
